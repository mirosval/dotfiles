...
legendary.setup({
  keymaps = {
    ...
    { "grt",         ":Telescope lsp_definitions<CR>",     description = "Search LSP Definitions" },
    { "grr",         ":Telescope lsp_references<CR>",      description = "Search LSP References" },
    { "gri",         ":Telescope lsp_implementations<CR>", description = "Search LSP Implementations" },
    {
      "gldv",
      function()
        vim.cmd("vsplit")
